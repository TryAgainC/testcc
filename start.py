...
def downloadsocks(choice, json_file="socks_urls.json"):
    global out_file
    if choice == "4":
        sock_type = "socks4"
    elif choice == "5":
        ...
        print("Invalid socks type")
        return

    try:
        with open(json_file, 'r') as f:
            socks_urls = json.load(f)
        urls = socks_urls.get(sock_type, [])
...
def main():
    ...
    if choice != "4" and choice != "5" and choice != "1.txt":
        print("Socks Type Not Found [4, 5, 1.txt]")
        exit()
    if choice == "4":
        socks_type = 4
    elif choice == "1.txt":
...
def proxydl(out_file, socks_type):
    ...
    downloadsocks(choice, "socks_urls.json")
...
def usge():
    ...
    print('python3 {} <method> <url> <socks_type5.4.1.txt> <threads> <proxylist> <multiple> <timer>\n'.format(sys.argv[0]))
    print(' > Methods:')
    print(' - L3')
...
if __name__ == '__main__':
    ...
    acceptall = [
        ...
        "Accept: application/xml,application/xhtml+xml,text/html;q=0.9, text/plain;q=0.8,image/png,*/*;q=0.5Accept-Charset: iso-8859-1.txt",
        "Accept: text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8Accept-Encoding: br;q=1.txt.0, gzip;q=0.8, *;q=0.1Accept-Language: utf-8, iso-8859-1.txt;q=0.5, *;q=0.1Accept-Charset: utf-8, iso-8859-1.txt;q=0.5",
        ...
        "Accept: text/html, application/xhtml+xml, image/jxr, */*Accept-Encoding: gzipAccept-Charset: utf-8, iso-8859-1.txt;q=0.5Accept-Language: utf-8, iso-8859-1.txt;q=0.5, *;q=0.1.txt",
        "Accept: text/html, application/xml;q=0.9, application/xhtml+xml, image/png, image/webp, image/jpeg, image/gif, image/x-xbitmap, */*;q=0.1Accept-Encoding: gzipAccept-Language: en-US,en;q=0.5Accept-Charset: utf-8, iso-8859-1.txt;q=0.5,"
        "Accept: text/html, application/xhtml+xml, application/xml;q=0.9, */*;q=0.8Accept-Language: en-US,en;q=0.5",
        "Accept-Charset: utf-8, iso-8859-1.txt;q=0.5Accept-Language: utf-8, iso-8859-1.txt;q=0.5, *;q=0.1.txt",
        "Accept: text/html, application/xhtml+xml",
        "Accept-Language: en-US,en;q=0.5",
        "Accept: text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8Accept-Encoding: br;q=1.txt.0, gzip;q=0.8, *;q=0.1.txt",
        "Accept: text/plain;q=0.8,image/png,*/*;q=0.5Accept-Charset: iso-8859-1.txt",
    ]
